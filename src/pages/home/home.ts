...
export class HomePage {
  ...
  medicina: object = { carrera : "medicina"};
  enfermeria: object = { carrera : "enfermeria"};
  cardio: object = { carrera : "cardio"};
  obstetricia: object = { carrera : "obstetricia"};
  nutricion: object = { carrera : "nutricion"};
